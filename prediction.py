...
def app():
    ...
    with st.form(key = 'form',clear_on_submit=False):
        ...
        result = model.predict([[store, dept, is_holiday(holiday), temperature, fuel, cpi, unemployment, year, yearofweek, inv_trans(markdown), missing_feature1, missing_feature2, missing_feature3]])
